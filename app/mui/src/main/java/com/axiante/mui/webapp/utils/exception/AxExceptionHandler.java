...
@Slf4j
public class AxExceptionHandler extends ExceptionHandlerWrapper {
    private ExceptionHandler wrapped;


    public AxExceptionHandler(ExceptionHandler wrapped) {
    ...
    public void handle() throws FacesException {
        ...
        while (iterator.hasNext()) {
            ...
            try {
                log.error("Error catched in catchall configuration", throwable);
