insert into MUIPROMO.APPLICATION_PROPERTIES(ID_APPLICATION_PROPERTIES,AP_KEY, AP_VALUE) values (5,'TM1_OPERATION_TIMEOUT','10');
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('117','/Reporting/Analisi_Budget-Venduto/Articolo',TO_CLOB('{
  ...
  ')
    ...
    || TO_CLOB('    "NON_EMPTY": false,
                    "DIMENSIONS": {
                      "}ElementAttributes_REP - Compratore": "{[}ElementAttributes_REP - Compratore].[Descrizione] }"
                    }
                  },
                  "FROM": "[}ElementAttributes_REP - Compratore]"
                },
                "ExecuteMDX": {
                  "Members": [
                    "Name",
    ...
    || TO_CLOB('
              {
                ...
                "MDX": {
                  "ROWS": {
                    "NON_EMPTY": true,
                    "DIMENSIONS": {
                      "Promozione": "{ ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo ')
    || TO_CLOB('Promozione],BASC)}"
                    }
                  },
                  "COLS": {
                    "NON_EMPTY": false,
                    "DIMENSIONS": {
                      "}ElementAttributes_Promozione": "{[}ElementAttributes_Promozione].[MUI_Descrizione] }"
                    }
                  },
            ...
            "configurations": [
              {
                ...
                "MDX": {
                  "ROWS": {
                    ...
                    "DIMENSIONS": {
                      "Compr')
    || TO_CLOB('atore": "{ EXCEPT( {TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, ASC)}, { [Compratore].[NA], [Compratore].[S000] }) }"
                    }
                  },
                  "COLS": {
                    "NON_EMPTY": false,
                  ...
                  "FROM": "[}ElementAttributes_Comprator')
    || TO_CLOB('e]"
                },
                "ExecuteMDX": {
                  "Members": [
            ...
            "configurations": [
              {
                ...
                "MDX": {
                  "ROWS": {
                    "NON_EMPTY": true,
                    "DIMENSIONS": {
                      "Promozione": "{ ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BD')
    || TO_CLOB('ESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}"
                    }
                  },
                  "COLS": {
                    "NON_EMPTY": false,
...
')
    ...
    || TO_CLOB('         "ROWS": {
                  ...
                  "COLS": {
                    "NON_EMPTY": false,
                    "DIMENSIONS": {
                      "}ElementAttributes_Compratore": "{[}ElementAttributes_Compra')
    || TO_CLOB('tore].[Descrizione] }"
                    }
                  },
    ...
    },
    {
      ...
      "MDX": {
        "ROWS": {
          ...
          "DIMENSIONS": {
            "Promozione": "{ OR')
    || TO_CLOB('DER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('16','/Pianificazione/Proiezioni',TO_CLOB(' {
  ...
  "configurations": [
    ...
    || TO_CLOB('   "Name",
      ...
      "autoGroupColumnDef": {
        ...
        "fie')
    || TO_CLOB('ld": "Categoria.Descrizione",
        "headerName": "Categoria",
        "cellClass": "cellClass-left-text",
        "width": 300,
        "pinned": "left",
            ...
            "configurations": [
              {
                ...
                "MDX": {
                  "ROWS": {
                    ...
                    "DIMENSIONS": {
                      "Promozione": "{ ORDER( ')
    || TO_CLOB('ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}"
                    }
                  },
                  "COLS": {
                    "NON_EMPTY": false,
        ...
        ')
    || TO_CLOB('          "FROM": "[}ElementAttributes_Promozione]"
                },
                "ExecuteMDX": {
                  "Members": [
                    "Name",
 ...
 ')
    ...
    || TO_CLOB('teger"],
          ...
          "%_ML": {
        ')
    || TO_CLOB('    "type": ["TM1DataColumnPercentage"],
            "cellClass": "cellClass-right-text"
          },
          "CONTR": {
            "type": ["TM1DataColumnNumber"],
    ...
    },
    {
      ...
      "MDX": {
        "ROWS": {
          "NON_EMPTY": true,
          "DIMENSIONS": {
            "Promozione": "{ ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSET')
    || TO_CLOB('ALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
            "Compratore": "{EXCEPT( {{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, ASC)}} , {[Categoria].[S000]}) }",
  ...
  ')
      ...
      "actions": [
        {
          ...
          ')
    || TO_CLOB('"process": "MUI_DUMMY_COPY.Promozione.Articolo+del",
          "timeout": -1,
          "refresh": [],
          "params": [
            {
    ...
    || TO_CLOB('ratore",
        ...
        },
        {
          ...
          "process": "MUI_DUMMY_CUB.Promo')
    || TO_CLOB('zione Pianificazione Pulizia Articoli",
          "timeout": -1,
          "refresh": [
            "gc_proiezioni_2"
          ],
    ...
    || TO_CLOB('Abilita Famiglia",
        ...
        {
     ')
    || TO_CLOB('     "componentId": "pnf_pro_inizializza",
          "componentLabel": "Inizializza",
...
')
    ...
    || TO_CLOB('   ],
          ...
          "paramName": "",
          "ref')
    || TO_CLOB('resh": ["gc_selezioneArticoliContributi_targetCategoria","gc_selezioneArticoliContributi_promozione"],
          "configuration": {
            "configurations": [
              {
                "name": "Compratore",
                ...
                "MDX": {
                  "ROWS": {
                    ...
                    "DIMENSIONS": {
                      "Compratore": "{ EXCEP')
    || TO_CLOB('T( {TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, ASC)}, { [Compratore].[NA], [Compratore].[S000] }) }"
                    }
                  },
                  "COLS": {
                    "NON_EMPTY": false,
  ...
  ')
    || TO_CLOB('          "cellClass": "cellClass-right-text"
      ...
      ')
    || TO_CLOB('    "FF_EC_NC_slash_ND_NO_Abbatt(€/pz)": {
            "type": ["TM1DataColumnInteger"],
            "cellClass": "cellClass-right-text"
          },
          "FF_C_%": {
  ...
  "configurations": [
    ...
    || TO_CLOB(',
                  ...
                  "COLS": {
                    "NON_EMPTY": false,
                    "DIMENSIONS": {
                      "}ElementAttributes_Promozione": "{[}ElementAttributes_P')
    || TO_CLOB('romozione].[MUI_Descrizione] }"
                    }
                  },
                  "FROM": "[}ElementAttributes_Promozione]"
                },
      ...
      "MDX": {
        "ROWS": {
          ...
          "DIMENSIONS": {
            "Promozione": "{[Promozione].[(I) Promozione]}",
            "Compratore": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, ASC)}}",
            "Fornitore": "{{TM1SORT( {TM1FILTERBYLE')
    || TO_CLOB('VEL( {TM1SUBSETALL( [Fornitore] )}, 0)}, ASC)}}",
            "Articolo": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Articolo] )}, 0)}, ASC)}}"
          }
        },
        "COLS": {
...
')
    || TO_CLOB('            "configurations": [
              {
                ...
                "MDX": {
                  "ROWS": {
                    "NON_EMPTY": true,
                    "DIMENSIONS": {
                      "Promozione": "{ ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Can')
    || TO_CLOB('ale], BASC),[Promozione].[Tipo Promozione],BASC)}"
                    }
                  },
                  "COLS": {
                    "NON_EMPTY": false,
    ...
    || TO_CLOB('"
      ...
      "columnDefs": [
        ...
        {"headerName":"Anno","field":"Promozione.Anno","width":70,"hide":true,"rowGroup": true , "editable": false,"cellClass')
    || TO_CLOB('": "cellClass-left-text","type":["TM1Element"]},
        ...
        {"headerName":"Descrizione + Data","field":"Promozione.MUI_Desc')
    || TO_CLOB('rizione","width":400,"hide":true,"rowGroup": false , "editable": false,"type":["TM1Element"]},
        ...
        {"headerName":"Data Fine Las","field":"MisuraPromozionePropriet_agrave_$Data_Fine_Las","width":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat",')
    || TO_CLOB(' "type":[ "TM1DataColumnDate"]},
        ...
        {"he')
    || TO_CLOB('aderName":"Data Inizio DRO/GEM","field":"MisuraPromozionePropriet_agrave_$Data_inizio_DRO_slash_GEM","width":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
        ...
        {"headerName":"Raccolta Proiezioni","f')
    || TO_CLOB('ield":"MisuraPromozionePropriet_agrave_$1_pubblicazione","width":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
        ...
        {"headerName":"Data Scadenza Conferma Prezzi","field":"MisuraPromozio')
    || TO_CLOB('nePropriet_agrave_$data_scadenza_conferma_prezzi","width":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
        ...
        {"headerName":"Volantino/Piano Media","field":"MisuraPromozionePropriet_agrave_$resp_mktg2","width":100,"hide":false,"rowGrou')
    || TO_CLOB('p": false , "editable": true,"type":["TM1DataColumnText"]},
        ...
        {"headerNam')
    || TO_CLOB('e":"Data Inizio Istituzionale","field":"MisuraPromozionePropriet_agrave_$Data_Inizio_ist_dot_","width":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
        ...
        {"headerName":"Data abb. prezzi","field":"M')
    || TO_CLOB('isuraPromozionePropriet_agrave_$Data_abb_prezzi","width":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
  ...
  ')
    ...
    || TO_CLOB('       "ROWS": {
                  ...
                  "COLS": {
                    ...
                    "DIMENSIONS": {
                      "')
    || TO_CLOB('}ElementAttributes_Promozione": "{[}ElementAttributes_Promozione].[MUI_Descrizione] }"
                    }
                  },
                  "FROM": "[}ElementAttributes_Promozione]"
                },
    ...
    || TO_CLOB('
      ...
      "MDX": {
        ...
        "COLS": {
          "NON_EMPTY": true,
          "DIMENSIONS": {
            "}ElementAttributes_Compratore": "{{TM1SORTBYINDEX( {TM1FILTERBYLEV')
    || TO_CLOB('EL( {TM1SUBSETALL( [}ElementAttributes_Compratore] )}, 0)}, ASC)}}"
          }
        },
        "FROM": "[}ElementAttributes_Compratore]",
        "WHERE": {
    ...
    || TO_CLOB('   "Consolidated",
      ...
      "columnDefs": [
        ...
        },
        {
          "headerName": "Reparto",
          "fi')
    || TO_CLOB('eld": "Compratore.MUI_Reparto",
          "width": 100,
          "hide": false,
          "rowGroup": false,
          "editable": false,
  ...
  ')
    ...
    || TO_CLOB('}"
        ...
        "COLS": {
          ...
          "DIMENSIONS": {
            "Promozione": "{ ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
            "Compratore": "{{ [Compratore].[TOT_COMP], [Compratore].[S22]},{ EXCEPT( {TM1SUBSETALL( [Compratore] )}, { [Compratore].[NA], [Compratore].[S000], [Compratore].[T')
    || TO_CLOB('OT_COMP], [Compratore].[S22]}) }}"
          }
        },
    ...
    || TO_CLOB('       "width": 300,
      ...
      "columnDefs": [
        ...
        },
        {
          ...
          "field": "RaggruppamentoF')
    || TO_CLOB('oto.MUI_TOTS",
          "width": 70,
          "hide": true,
          "rowGroup": true,
          "editable": false,
...
')
    ...
    || TO_CLOB('EMPTY": true,
                  ...
                  "COLS": {
                    "NON_EMPTY": false,
                    "DIMENSIONS": {
                      "}ElementAttributes_Promozione": "{[}Element')
    || TO_CLOB('Attributes_Promozione].[MUI_Descrizione] }"
                    }
                  },
                  "FROM": "[}ElementAttributes_Promozione]"
                },
    ...
    || TO_CLOB(',
      "MDX": {
        ...
        "COLS": {
          "NON_EMPTY": true,
          "DIMENSIONS": {
            "}ElementAttributes_Compratore": "{{TM1SORTBYINDEX( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [}Elemen')
    || TO_CLOB('tAttributes_Compratore] )}, 0)}, ASC)}}"
          }
        },
        "FROM": "[}ElementAttributes_Compratore]",
        "WHERE": {
    ...
    || TO_CLOB(' "name": "REP - Compratore",
                ...
                "MDX": {
                  "ROWS": {
                    "NON_EMPTY": true,
                    "DIMENSIONS": {
                       "REP - Compratore": "{ EXCEPT( {TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Compratore] )}, 0)}, ASC)}, { [REP - Compratore].[NA], [REP - Compratore].[S000] }) }"
                    }
                  },
')
    || TO_CLOB('
            ...
            "configurations": [
              {
                ...
                "MDX": {
                  "ROWS": {
                    "NON_EMPTY": true,
                    "DIMENSIONS": {
                       "REP - Scenario": "{TM1SORT')
    || TO_CLOB('(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Scenario] )}, 0)} , ASC)}"
                    }
                  },
                  "COLS": {
                    "NON_EMPTY": false,
                    "DIMENSIONS": {
                      "}ElementAttributes_REP - Scenario": "{[}ElementAttributes_REP - Scenario].[Descrizione] }"
                    }
                  },
                  "FROM": "[}ElementAttributes_REP - Scenario]"
                },
                "ExecuteMDX": {')
    || TO_CLOB('
                  "Members": [
    ...
    || TO_CLOB('mory": true,
                ...
                "MDX": {
                  ...
                  "COLS": {
                    ...
                    "DIMENSIONS": {
           ')
    || TO_CLOB('           "}ElementAttributes_REP - Compratore": "{[}ElementAttributes_REP - Compratore].[Descrizione] }"
                    }
                  },
                  "FROM": "[}ElementAttributes_REP - Compratore]"
                },
...
')
    ...
    || TO_CLOB('        ,
		...
		"columnDefs": [
			...
			{"headerName')
    || TO_CLOB('":"Compratore","field":"Compratore.MUI_Descrizione","width":70,"hide":true,"rowGroup": true, "pinned": "left", "editable": false,"type":["TM1Element"]},
			...
			{"headerName":"Livello Categoria","field":"Categoria.MUI_Level","width":70,"hide":true,"rowGroup": false, "pinned": "left", "editable": false,"type":["TM1Element"]},{"headerName":"')
    || TO_CLOB('Cod Categoria","field":"Categoria.Name","width":70,"hide":true,"rowGroup": false,  "editable": false,"type":["TM1Element"]}
		],
		"rowClassRules": {
			"row_style_hidden": "(data.Compratore.Name == ''TOT_COMP'' && data.Categoria.MUI_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_Level > 0)",
			"row_style_1" : "data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.')
    || TO_CLOB('Categoria.Name)",
			"row_style_2" : "data.Compratore.Name==''S000'' && [''_REP_01_01'',''_REP_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
			"row_style_3" : "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 1",
			"row_style_4" : "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 2"
		},
		"groupRowAggNodes": {
			"nodeGroupTrue" : "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore')
    || TO_CLOB('.Name != ''S000''",
    ...
    || TO_CLOB('re.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
		}
	}]
}'),'GRID');
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('52','/Timone/Target_Categoria/Data',TO_CLOB(' {
    ...
    || TO_CLOB('_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NETTO]},{[Misura Timone.].[MARGINE_LORDO_%]},{[Misura Timone.].[D_FOTO_slash_TGT_REP]},{[Misura Timone.].[D_FOTO_SCAFF_slash_TGT_REP]},{[Misura Timone.].[ASSORT_P]} }"
				}
			},
			"FROM": "[Timone Categoria]",
			"WHERE": {
...
')
    ...
    || TO_CLOB('lo Categoria",
		...
		"rowClassRules": {
			"row_style_hidden": "(data.Compratore.Name == ''S000'' && data.Categoria.Name ')
    || TO_CLOB('== ''CAT_0000'') || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.MUI_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_Level > 0)",
			"row_style_1": "data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)",
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('54','/Timone/Target_Categoria/Promo',TO_CLOB(' {
    ...
    || TO_CLOB('ura Timone.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NETTO]},{[Misura Timone.].[MARGINE_LORDO_%]},{[Misura Timone.].[D_FOTO_slash_TGT_REP]},{[Misura Timone.].[D_FOTO_SCAFF_slash_TGT_REP]},{[Misura Timone.].[ASSORT_P]}}"
				}
			},
			"FROM": "[Timone Categoria]",
			"WHERE": {
...
"UniqueName"
    ...
    || TO_CLOB('TM1Element"]
		...
		"rowClassRules": {
			"row_style_hidden": "(data.')
    || TO_CLOB('Compratore.Name == ''S000'' && data.Categoria.Name == ''CAT_0000'') || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.MUI_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_Level > 0)  ",
			"row_style_1": "data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)",
    ...
    || TO_CLOB(',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
		...
		"groupRowAggNodes": {
			"nodeGroupTrue": "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore.Name != ''S000''",
			"nodeGroupFalse": "((data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_0')
    || TO_CLOB('4'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)) || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
		}
	}]
}
'),'GRID');
    ...
    || TO_CLOB('umnName": "REP - Scenario",
		...
		"list_ATTR": [
			...
			},
			{
				...
				')
    || TO_CLOB('"ATTR_columnName": "SubGrm Desc",
...
')
	...
	},
	{
		...
		"DIM_colum')
    || TO_CLOB('nName": "REP - Meccanica Semplice",
    ...
    || TO_CLOB('REP - Misura Reporting Articolo] )}, 0)}, ASC)}}",
		"list_ATTR": [
			{
				"ATTR_code": "descrizione",
				"ATTR_columnName": "Descrizione",
	...
	},
	{
		...
		"ENDPOINT_serverName": "promo",
		"MDX_jsonSource": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Misura Timone.] )}, 0)}, AS')
    || TO_CLOB('C)}}",
		"list_ATTR": [
			{
				"ATTR_code": "descrizione",
    ...
    || TO_CLOB('            {
      ...
      },
      {
              ...
              "ENDPOINT_serverName": "promo",
              "MDX_jsonSource": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Iniziati')
    || TO_CLOB('va] )}, 0)}, ASC)}}",
              "list_ATTR": [
                  {
                      "ATTR_code": "Descrizione",
      ...
      },
	{
		...
		"ENDPOINT_serverName": "promo",
		"MDX_jsonSource": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Articolo] )}, 1)}, A')
    || TO_CLOB('SC)}}",
		"list_ATTR": [
			{
				"ATTR_code": "categoriadesc",
	...
	{
		"DIM_cod')
    || TO_CLOB('e": "misuraProgrammazioneFornitore",
	...
	"configurations": [{
		...
		"MDX": {
			...
			"COLS": {
				...
				"DIMENSIONS": {
	')
    || TO_CLOB('				"Promozione": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)}, ASC)}}",
					"Scenario": " {{[Scenario].[RIF_MKT_DT]},{[Scenario].[TGT_ACQ]}}",
					"Misura Timone.": "{{[Misura Timone.].[N_ART_PROMO]},{[Misura Timone.].[TOT_FOTO]},{[Misura Timone.].[N_FOTO]},{[Misura Timone.].[N_FOTO_SCAFFALE]},{[Misura Timone.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NETTO]},{[Misura Timone.].[SPZ_CAMP]},')
    || TO_CLOB('{FILTER( {TM1SUBSETALL( [Misura Timone.] )}, [Misura Timone.].[Tipo] = ''Spazi'')} , { [Misura Timone.].[ASSORT_P]}  }"
				}
			},
			"FROM": "[Timone Categoria]",
			"WHERE": {
...
')
    || TO_CLOB('					"Promozione": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)}, ASC)}}",
					...
					"Misura Timone.": "{{[Misura Timone.].[N_ART_PROMO]},{[Misura Timone.].[TOT_FOTO]},{[Misura Timone.].[N_FOTO]},{[Misura Timone.].[N_FOTO_SCAFFALE]},{[Misura Timone.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[SPZ_CAMP]},{FILTER( {TM1SUBS')
    || TO_CLOB('ETALL( [Misura Timone.] )}, [Misura Timone.].[Tipo] = ''Spazi'')}   }"
				}
			},
			"FROM": "[Timone Categoria]",
			"WHERE": {
...
"UniqueName"
    ...
    || TO_CLOB('roupShow":"always"
		...
		"columnDefs": [
			{"headerName":"CategoryManager"')
    || TO_CLOB(',"field":"Compratore.CategoryManager","width":70,"hide":true,"rowGroup": true, "pinned": "left", "editable": false,"type":["TM1Element"]},
			{"headerName":"Compratore","field":"Compratore.MUI_Descrizione","width":70,"hide":true,"rowGroup": true, "pinned": "left", "editable": false,"type":["TM1Element"]},
			{"headerName":"Cod Compratore","field":"Compratore.Name","width":70,"hide":true,"rowGroup": false, "pinned": "left", "editable": false,"type":["TM1Element"]},
			{"headerName":"Livello Ca')
    || TO_CLOB('tegoria","field":"Categoria.MUI_Level","width":70,"hide":true,"rowGroup": false, "pinned": "left", "editable": false,"type":["TM1Element"]},{"headerName":"Cod Categoria","field":"Categoria.Name","width":70,"hide":true,"rowGroup": false,  "editable": false,"type":["TM1Element"]}
		],
		"rowClassRules": {
			"row_style_hidden": "(data.Compratore.Name == ''TOT_COMP'' && data.Categoria.MUI_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_Level > 0)",
			"row_style_1" : "dat')
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('130','/Timone/Target_Categoria/Promo_(CAT)',TO_CLOB(' {
    ...
    || TO_CLOB('UTO_PROMO_NETTO]},{[Misura Timone.].[MARGINE_LORDO_%]},{[Misura Timone.].[D_FOTO_slash_TGT_REP]},{[Misura Timone.].[D_FOTO_SCAFF_slash_TGT_REP]},{[Misura Timone.].[ASSORT_P]}}"
				}
			},
			"FROM": "[Timone Categoria]",
			"WHERE": {
...
"UniqueName"
    ...
    || TO_CLOB('lumnGroupShow": "always",
		...
		"columnDefs": [
			...
			},
			{
				"headerName": "Compratore",
				"fiel')
    || TO_CLOB('d": "Compratore.MUI_Descrizione",
				"width": 70,
				"hide": true,
				"rowGroup": true,
				"pinned": "left",
    ...
    || TO_CLOB('	"hide": true,
		...
		"rowClassRules": {
			"row_style_hidden": "(data.Compratore.Name == ''TOT_COMP'' && data.Categoria.MUI_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_')
    || TO_CLOB('Level > 0)",
			"row_style_1": "data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)",
			"row_style_2": "data.Compratore.Name==''S000'' && [''_REP_01_01'',''_REP_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
			"row_style_3": "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 1",
			"row_style_4": "data.C')
    || TO_CLOB('ompratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 2"
		},
		"groupRowAggNodes": {
			"nodeGroupTrue": "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore.Name != ''S000''",
			"nodeGroupFalse": "((data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)) || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.C')
    || TO_CLOB('ompratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
		}
	}]
}
'),'GRID');
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('132','/Timone/Target_Categoria/Promo_(ACQ)',TO_CLOB(' {
    ...
    || TO_CLOB('_PROMO]},{[Misura Timone.].[TOT_FOTO]},{[Misura Timone.].[N_FOTO]},{[Misura Timone.].[N_FOTO_SCAFFALE]},{[Misura Timone.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NETTO]},{[Misura Timone.].[MARGINE_LORDO_%]},{[Misura Timone.].[D_FOTO_slash_TGT_REP]},{[Misura Timone.].[D_FOTO_SCAFF_slash_TGT_REP]},{[Misura Timone.].[ASSORT_P]}}"
				}
			},
			"FROM": "[Timone Categoria]",
			"WHERE": {
		...
		"columnDefs": [
			{
				"headerName": "CategoryManager",
')
    || TO_CLOB('				"field": "Compratore.CategoryManager",
				"width": 70,
				"hide": true,
				"rowGroup": true,
				"pinned": "left",
    ...
    || TO_CLOB('Categoria.Name)",
		...
		"groupRowAggNodes": {
			"nodeGroupTrue": "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore.Nam')
    || TO_CLOB('e != ''S000''",
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('134','/Timone/Target_Categoria/Data_(CAT)',TO_CLOB(' {
    ...
    || TO_CLOB('_PROMO_NETTO]},{[Misura Timone.].[MARGINE_LORDO_%]},{[Misura Timone.].[D_FOTO_slash_TGT_REP]},{[Misura Timone.].[D_FOTO_SCAFF_slash_TGT_REP]},{[Misura Timone.].[ASSORT_P]} }"
				}
			},
			"FROM": "[Timone Categoria]",
			"WHERE": {
...
')
    ...
    || TO_CLOB('ide": true,
		...
		"rowClassRules": {
			"row_style_hidden": "(data.Compratore.Name == ''TOT_COMP'' && data.Categoria.MUI_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI')
    || TO_CLOB('_Level > 0)",
			"row_style_1": "data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)",
			"row_style_2": "data.Compratore.Name==''S000'' && [''_REP_01_01'',''_REP_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
			"row_style_3": "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 1",
			"row_style_4": "data.')
    || TO_CLOB('Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 2"
		},
		"groupRowAggNodes": {
			"nodeGroupTrue": "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore.Name != ''S000''",
			"nodeGroupFalse": "((data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)) || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.')
    || TO_CLOB('Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
		}
	}]
}
'),'GRID');
...
')
    ...
    || TO_CLOB('    "MDX": {
                  ...
                  "COLS": {
                    "NON_EMPTY": false,
                    "DIMENSIONS": {
                      "}ElementAttributes_REP - Compratore": "{[}ElementAttributes_REP - Compratore].[D')
    || TO_CLOB('escrizione] }"
                    }
                  },
                  "FROM": "[}ElementAttributes_REP - Compratore]"
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('136','/Timone/Target_Categoria/Data_(ACQ)',TO_CLOB(' {
    ...
    || TO_CLOB('FOTO]},{[Misura Timone.].[N_FOTO]},{[Misura Timone.].[N_FOTO_SCAFFALE]},{[Misura Timone.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NETTO]},{[Misura Timone.].[MARGINE_LORDO_%]},{[Misura Timone.].[D_FOTO_slash_TGT_REP]},{[Misura Timone.].[D_FOTO_SCAFF_slash_TGT_REP]},{[Misura Timone.].[ASSORT_P]} }"
				}
			},
			"FROM": "[Timone Categoria]",
			"WHERE": {
