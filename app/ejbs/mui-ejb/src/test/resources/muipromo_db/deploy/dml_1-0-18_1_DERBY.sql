...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (9,'/Fatturazione/Associazione_Articoli_Promozione',('  {
	"connection": "promo",
	"configurations": [
		{
    ...
    || ('YLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, DESC)}}",
		...
		},
		{
			...
			"MDX": {
				"ROWS": {
					...
					"DIMENSIONS": {
						"Promozione": "{{TM1SORT( ')
    || ('{TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)}, DESC)}}",
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (10,'/Fatturazione/Associazioni_Articoli',('  {
  "connection": "promo",
  "configurations": [
    {
    ...
    || ('omozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
            "Misura Fatturazione": "{[Misura Fatturazione].[I-Fatturazione Contributi]}"
          }
        },
        "FROM": "[Fatturazione]",
 ...
 ')
    ...
    || ('[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
            "Misura Fatturazione": "{[Misura Fatturazione].[ASS_RATA],[Misura Fatturazione].[OK]}"
          }
        },
        "FROM": "[Fatturazione Articolo]",
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (11,'/Fatturazione/Contribuzione_Campagna',(' {
	"connection": "promo",
    ...
    || (': "sum", "columnGroupShow":"always",  "editable": true, "type":[ "TM1DataColumnText"] },
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (12,'/Fatturazione/Contribuzione_Promozioni',(' {
  "connection": "promo",
  "configurations": [
    {
    ...
    || ('zione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
            "Compratore": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, DESC)}}",
            "Fornitore": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Fornitore] )}, 0)}, DESC)}}",
            "Rata": "{ EXCEPT( { EXCEPT( { EXCEPT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Rata] )}, 0)}, { [Rata].[RATA_UNICA] }) }, { [Rata].[PROGR_CONTR] }) }, { [Rata].[PROGR_EX_CONTR] ')
    || ('}) }"
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (13,'/Pianificazione/Articoli_Fittizi',(' {
  "connection": "promo",
  "configurations": [
    {
      ...
      "MDX": {
        ...
        "COLS": {
          ...
          "DIMENSIONS": {
            "Misura ')
    || ('Articolo Fittizio": "{[Misura Articolo Fittizio].[(I) Aggiornamento Articoli Fittizi]}"
          }
        },
  ...
  ')
    || ('            "label": "Compratore",
        ...
        },
        {
          ...
          "process": ')
    || ('"MUI_DUMMY_CUB.Articolo Fittizio.SpostaSuArtEff_new",
          "timeout": -1,
          "refresh": [
            "gc_articoliFittizi"
          ],
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (14,'/Pianificazione/Differenziazione_Zone',(' {
  "connection": "promo",
  "configurations": [
    {
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (15,'/Pianificazione/Meccaniche_Set',(' {
  "connection": "promo",
  "configurations": [
    {
    ...
    || ('zione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (16,'/Pianificazione/Proiezioni',(' {
  "connection": "promo",
  "configurations": [
    {
      ...
      "MDX": {
        "ROWS": {
          ...
          "DIMENSIONS": {
            "Promozione": "{ ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
            "Comprator')
    || ('e": "{EXCEPT( {{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, ASC)}} , {[Categoria].[S000]}) }",
...
')
    ...
    || ('e].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
            "Compratore": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, ASC)}}",
            "Articolo": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Articolo] )}, 0)}, ASC)}}"
          }
        },
    ...
    || ('romozione Pianificazione].([}ElementAttributes_Misura Promozione Pianificazione].[Ordinamento])>0 )})"
          }
        },
 ...
 ')
  ...
  ')
    ...
    || ('_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (17,'/Pianificazione/Selezione_Articoli_Contributi',(' {
  "connection": "promo",
  "configurations": [
    {
    ...
    || ('ASC)}",
        ...
        "COLS": {
          ...
          "DIMENSIONS": {
            "Scenario": "{[Scenario].[(I) Scenario Timone Pianificazione]}",
            "Misura Timone.": "{[')
    || ('Misura Timone.].[(I) Misura Timone Pianificazione]}"
          }
        },
        "FROM": "[Timone Categoria II]",
        "WHERE": {
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (18,'/Pianificazione/Selezione_Famiglie_Contributi',(' {
  "connection": "promo",
  "configurations": [
    {
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (19,'/Pianificazione/Selezione_Promo',('  {
  "connection" : "promo" ,
  "configurations": [
    {
    ...
    || ('le], BASC),[Promozione].[Tipo Promozione],BASC)}"
          }
        },
        "COLS": {
          "NON_EMPTY": false,
    ...
    || ('",
      ...
      "columnDefs": [
        {"he')
    || ('aderName":"Canale","field":"Promozione.Canale","width":100,"hide":true,"rowGroup": true , "editable": false,"cellClass": "cellClass-left-text","type":["TM1Element"]},
    ...
    || ('":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
    ...
    || ('e,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
    ...
    || ('M1DataColumnDate"]},
        ...
        {"headerName":')
    || ('"Data Pre-Presentazione CS","field":"MisuraPromozionePropriet_agrave_$data_riunione_commerciale","width":100,"hide":false,"rowGroup": false , "editable": false,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
        ...
        {"headerName":"Pianific')
    || ('azione TM1/GPR","field":"MisuraPromozionePropriet_agrave_$resp_mktg1","width":100,"hide":false,"rowGroup": false , "editable": true,"type":["TM1DataColumnText"]},
    ...
    || ('le": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
    ...
    || ('nto Fragola","field":"MisuraPromozionePropriet_agrave_$ValorePuntoFragola","width":100,"hide":false,"rowGroup": false , "editable": true,"type":["TM1DataColumnDecimal3"]}
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (20,'/Piano_Annuale/Controllo_Negozi',(' {
	"connection": "promo",
	"configurations": [
		{
    ...
    || ('eger",
						...
						},
						{
							"headerName": "N. Foto Speciali",
							"field": "Scena')
    || ('rio$TGT_REP$$MisuraTimone_dot_$N_FOTO_SPEC",
							"width": 80,
							"hide": false,
							"rowGroup": false,
							"aggFunc": "sum",
    ...
    || ('nteger",
						...
						},
						{
							...
							"fi')
    || ('eld": "Scenario$TGT_REP$$MisuraTimone_dot_$D_FOTO_SCAFF_slash_TGT_MKT",
							"width": 80,
							"hide": false,
							"rowGroup": false,
							"aggFunc": "sum",
    ...
    || ('r",
						...
						},
						{
							"headerName": "N. Foto Speciali",
							"field": "Scenario$')
    || ('TGT_ACQ$$MisuraTimone_dot_$N_FOTO_SPEC",
							"width": 80,
							"hide": true,
							"rowGroup": false,
							"aggFunc": "sum",
    ...
    || (',
						...
						},
						{
							...
							"field": "S')
    || ('cenario$TGT_ACQ$$MisuraTimone_dot_$D_FOTO_SCAFF_slash_TGT_REP",
							"width": 80,
							"hide": true,
							"rowGroup": false,
							"aggFunc": "sum",
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (21,'/Piano_Annuale/Crea_Promozione',(' {
	"connection": "promo",
	"configurations": [
		{
...
')
   ...
   ')
    ...
    || ('h":100,"hide":true,"rowGroup": true , "editable": false,"type":["TM1Element"]},
    ...
    || ('idth":160,"hide":false,"rowGroup": false , "editable": true, "type":[ "TM1DataColumnText"]},
              ...
              {"headerName":"Sottogr')
    || ('uppo","field":"MisuraPianoOperativoCommerciale$Canale","width":120,"hide":false,"rowGroup": false , "editable": true, "type":[ "TM1DataColumnText"]} ,
    ...
    || ('lse,"rowGroup": false , "editable": true, "cellClass": "dateFormat", "type":[ "TM1DataColumnDate" ,"numericColumn"]},
    ...
    || (',"rowGroup": false , "editable": true, "cellClass": "dateFormat", "type":[ "TM1DataColumnDate" ,"numericColumn"]},
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (22,'/Piano_Annuale/Foto',(' {
  "connection": "promo",
  "configurations": [
    {
      "name": "gc_Foto",
    ...
    || ('LEVEL( {TM1SUBSETALL( [Raggruppamento Foto] )}, 0)}}, [Raggruppamento Foto].[MUI_NRFOTO] <= 30.000000)}, ASC)}}"
          }
        },
        "COLS": {
          "NON_EMPTY": false,
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (23,'/Piano_Annuale/Gabbia',(' {
  "connection": "promo",
  "configurations": [
    {
      "name": "gc_Gabbia",
   ...
   ')
    ...
    || ('type":["TM1Element"]},
        ...
        {"headerName":"Descr')
    || ('izione + Data","field":"Promozione.Descrizione_plus_Data","width":150,"hide":true,"rowGroup": false , "editable": false,"type":["TM1Element"]},
...
"UniqueName"
    ...
    || ('th":100,"hide":false,"rowGroup": false , "editable": true,"type":[ "TM1DataColumnNumber" ,"numericColumn"]}
      ],
      "actions": [{
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (24,'/Piano_Annuale/Gestione_Contributi',(' {
  "connection": "promo",
  "configurations": [
    {
      ...
      "MDX": {
        "ROWS": {
          ...
          "DIMENSIONS": {
            "Promozione": "{ ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
            "Tip')
    || ('o Promozione": "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Tipo Promozione] )}, 0)}, ASC)}}"
 ...
 ')
    ...
    || ('omozione.Descrizione","width":400,"hide":true,"rowGroup": false , "editable": false,"type":["TM1Element"]},
        {"headerName":"Descrizione + Data","field":"Promozione.Descrizione_plus_Data","width":400,"hide":true,"rowGroup": false , "editable": false,"type":["TM1Element"]}
      ],
      "groupRowAggNodes": {
        "nodeGroupTrue" : "false",
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (25,'/Piano_Annuale/Gestione_Iniziative',(' {
  "connection": "promo",
  "configurations": [
    {
      ...
      "MDX": {
        "ROWS": {
          ...
          "DIMENSIONS": {
            "Promozione": "{ ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
            "In')
    || ('iziativa": "{{TM1SORTBYINDEX( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Iniziativa] )}, 0)}, ASC)}}"
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (26,'/Piano_Annuale/Meccaniche',(' {
  "connection": "promo",
  "configurations": [
    {
      "name": "gc_Meccaniche",
    ...
    || (' , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}"
          }
        },
        "COLS": {
          "NON_EMPTY": false,
...
')
    ...
    || ('cellClass-center-text","type":["TM1Element"]},
    ...
    || ('mplici",
        ...
        {"headerName":"P')
    || ('. Fragola","field":"MeccanicaComplesse$M004","width":110,"hide":false,"rowGroup": false , "editable": true, "cellClass": "cellClass-center-text","type":["TM1DataColumnText"]},
    ...
    || ('alse , "editable": true, "cellClass": "cellClass-center-text","type":["TM1DataColumnText"]},
    ...
    || ('110,"hide":false,"rowGroup": false , "editable": true, "cellClass": "cellClass-center-text","type":["TM1DataColumnText"]},
    ...
    || (' cliente (%)","field":"MeccanicaComplesse$M024","width":170,"hide":false,"rowGroup": false , "editable": true, "cellClass": "cellClass-center-text","type":["TM1DataColumnText"]},
    ...
    || ('owGroup": false , "editable": true, "cellClass": "cellClass-center-text","type":["TM1DataColumnText"]},
 ...
 ')
    || ('       {"headerName":"Buono Sconto Categoria - sconto percentuale","field":"MeccanicaComplesse$M035","width":170,"hide":false,"rowGroup": false , "editable": true, "cellClass": "cellClass-center-text","type":["TM1DataColumnText"]},
        ...
        {"headerName":"Buono S')
    || ('conto Categoria - PF - Set semplice","field":"MeccanicaComplesse$M134","width":170,"hide":false,"rowGroup": false , "editable": true, "cellClass": "cellClass-center-text","type":["TM1DataColumnText"]},
    ...
    || ('ld":"MeccanicaComplesse$M165","width":170,"hide":false,"rowGroup": false , "editable": true, "cellClass": "cellClass-center-text","type":["TM1DataColumnText"]}
    ...
    || ('e$M205","width":110,"hide":false,"rowGroup": false , "editable": true, "cellClass": "cellClass-center-text","type":["TM1DataColumnText"]},
    ...
    || (', "cellClass": "cellClass-center-text","type":["TM1DataColumnText"]},
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (27,'/Piano_Annuale/Modifica_Promozione',(' {
	"connection": "promo",
	"configurations": [
		{
   ...
   ')
    ...
    || ('editable": false,"type":["TM1Element"]},
              {"headerName":"Canale","field":"Promozione.Canale","width":70,"hide":true,"rowGroup": true , "editable": false,"type":["TM1Element"]} ,
    ...
    || ('le": true, "type":[ "TM1DataColumnText" ]},
    ...
    || ('mmerciale$DataInizio","width":85,"hide":false,"rowGroup": false , "editable": true, "cellClass": "dateFormat", "type":[ "TM1DataColumnDate" ,"numericColumn"]},
    ...
    || ('5,"hide":false,"rowGroup": false , "editable": true, "cellClass": "dateFormat", "type":[ "TM1DataColumnDate" ,"numericColumn"]},
    ...
    || ('p": false , "editable": true, "cellClass": "dateFormat", "type":[ "TM1DataColumnDate" ,"numericColumn"]},
    ...
    || ('ditable": true, "cellClass": "dateFormat", "type":[ "TM1DataColumnDate" ,"numericColumn"]},
    ...
    || ('tivoCommerciale$ETICH_SENZA__perc__AGG","width":100,"hide":false,"rowGroup": false , "editable": true, "type":[ "TM1DataColumnText"]},
    ...
    || ('","width":80,"hide":false,"rowGroup": false , "editable": true, "type":[ "TM1DataColumnText"]},
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (28,'/Piano_Annuale/Negozi_Promo',(' {
	"connection": "promo",
	"configurations": [
		{
			"name": "gc_NegoziPromo",
    ...
    || (': {
                    ...
                    "Misura Canale": ')
    || ('"{ [Misura Canale].[Tipo_Neg_Calc], [Misura Canale].[Tipo_Neg_Input], [Misura Canale].[Canale], [Misura Canale].[DataInizio], [Misura Canale].[DataFine],[Misura Canale].[Delta] }"
   ...
   ')
    ...
    || ('emestre","width":80,"hide":true,"rowGroup": true , "editable": false,"type":["TM1Element"]},
    ...
    || ('ide":true,"rowGroup": false , "editable": false,"type":["TM1Element"]}
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (29,'/Piano_Annuale/Timing',(' {
  "connection": "promo",
  "configurations": [
    {
      "name": "gc_Timing",
 ...
 ')
    ...
    || ('re","width":70,"hide":true,"rowGroup": true , "editable": false,"type":["TM1Element"]},
          {"headerName":"Riferimento","field":"Promozione.Riferimento","width":90,"hide":false,"rowGroup": false , "editable": false,"type":["TM1Element"]},
    ...
    || ('rave_$Data_Inizio_Las","width":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
          {"headerName":"Data Fine Las","field":"MisuraPromozionePropriet_agrave_$Data_Fine_Las","width":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
          {"headerName":"Data Inizio Freschi","field":"MisuraPromozionePropriet_agrave_$Data_Inizio_Freschi","width":100,"hide":false,"r')
    || ('owGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
          {"headerName":"Data Fine Freschi","field":"MisuraPromozionePropriet_agrave_$Data_Fine_Freschi","width":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
    ...
    || ('cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
          {"headerName":"Data Fine DRO/GEM","field":"MisuraPromozionePropriet_agrave_$Data_fine_DRO_slash_GEM","width":100,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
    ...
    || ('width":70,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
    ...
    || (': true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (30,'/Piano_Annuale/Visualizza_Piano',(' {
  "connection": "promo",
  ...
  "configurations": [
    ...
    || ('Anno","width":80,"hide":true,"rowGroup": true , "editable": false,"type":["TM1Element"]},
    ...
    || ('alse , "editable": true, "cellClass": "dateFormat", "type":[ "TM1DataColumnDate" ,"numericColumn"]},
    ...
    || ('Class": "dateFormat", "type":[ "TM1DataColumnDate" ,"numericColumn"]},
    ...
    || ('mmerciale$NO_STMP_ETICH","width":110,"hide":false,"rowGroup": false , "editable": true, "type":[ "TM1DataColumnText"]},
...
')
    || ('        {"headerName":"Note Marketing","field":"MisuraPianoOperativoCommerciale$NoteMarketing","width":110,"hide":false,"rowGroup": false , "editable": true, "type":[ "TM1DataColumnText"]}
      ]
    }
  ]
}
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (31,'/Piano_Annuale/Zone_Promo',(' {
  "connection": "promo",
  "configurations": [
    {
      "name": "gc_ZonePromo",
    ...
    || ('
      ...
      "columnDefs": [
        {"header')
    || ('Name":"Canale","field":"Promozione.Canale","width":100,"hide":true,"rowGroup": true , "editable": false,"type":["TM1Element"]},
        {"headerName":"Anno","field":"Promozione.Anno","width":70,"hide":true,"rowGroup": true , "editable": false,"type":["TM1Element"]},
        {"headerName":"Semestre","field":"Promozione.MUI_Semestre","width":70,"hide":true,"rowGroup": true , "editable": false,"type":["TM1Element"]},
        {"headerName":"Descrizione","field":"Promozione.Descrizione","width":40')
    || ('0,"hide":true,"rowGroup": false , "editable": false,"type":["TM1Element"]},
        {"headerName":"Descrizione + Data","field":"Promozione.Descrizione_plus_Data","width":400,"hide":true,"rowGroup": false , "editable": false,"type":["TM1Element"]} ,
    ...
    || ('01","width":125,"hide":false,"rowGroup": false , "editable": true,"aggFunc":"sum", "type":["TM1DataColumnInteger"]},
    ...
    || ('ue,"aggFunc":"sum", "type":["TM1DataColumnInteger"]}
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (32,'/Piano_Annuale/Sezioni_Tematiche/Sezioni_Tematiche',(' {
  "connection": "promo",
  "configurations": [
    {
...
')
    ...
    || ('   ] ,
      ...
      "columnDefs": [
        {"headerName":"')
    || ('Canale","field":"Promozione.Canale","width":60,"hide":true,"rowGroup": true , "editable": false,"type":["TM1Element"]},
    ...
    || ('width":100,"hide":true,"rowGroup": true, "editable": false,"type":["TM1Element"]},
    ...
    || ('hide":false,"rowGroup": false , "editable": true,"type":["TM1DataColumnText"]},
    ...
    || ('aFine","width":70,"hide":false,"rowGroup": false , "editable": true,"cellClass": "dateFormat", "type":[ "TM1DataColumnDate"]},
    ...
    || ('roup": false , "editable": true,"aggFunc":"sum", "type":["TM1DataColumnInteger"]},
        ...
        {"headerName":"Check","f')
    || ('ield":"MisuraZonaPromo$Check","width":70,"hide":false,"rowGroup": false , "editable": true,"type":["TM1DataColumnText"]}
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (33,'/Piano_Annuale/Sezioni_Tematiche/Crea_Sezioni_Tematiche',(' {
	"connection": "promo",
	"configurations": [
		{
    ...
    || ('00,"hide":false,"rowGroup": false , "editable": false,"type":["TM1Element"]},
    ...
    || ('zioneSezioneTematica$Note","width":170,"hide":false,"rowGroup": false , "editable": true,"type":["TM1DataColumnText"]},
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (34,'/Piano_Annuale/Spazi/Macrospazi_Listino_Promo',(' {
  "connection": "promo",
  "configurations": [
    {
 ...
 ')
    ...
    || ('h":260,"hide":false,"rowGroup": false ,"aggFunc": "sum", "columnGroupShow":"closed",  "editable": true, "type":[ "TM1DataColumnInteger" ,"numericColumn"] },
        "childrenCustomTypes"  : {
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (35,'/Piano_Annuale/Spazi/Macrospazi_Negozi_Promo',(' {
  "connection": "promo",
  "configurations": [
    {
    ...
    || ('ione_Macrospazi_Neg_Promo].[SPAZIO]}"
          }
        },
  ...
  ')
    ...
    || ('false , "editable": false,"type":["TM1Element"]}
      ]
    }
  ]
}
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (36,'/Piano_Annuale/Spazi/Macrospazi_Negozi',(' {
  "connection": "promo",
  "configurations": [
    {
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (37,'/Piano_Annuale/Spazi/Macrospazi',(' {
  "connection": "promo",
  "configurations": [
    {
      ...
      "MDX": {
        ...
        "COLS": {
          ...
          "DIMENSIONS": {
            "Misura_Macrospazi"')
    || (': "{[Misura_Macrospazi].[(I) Macro Spazi]}"
          }
        },
    ...
    || ('Show":"always",  "editable": true, "type":[ "TM1DataColumnInteger" ,"numericColumn"] },
        "childrenCustomTypes"  : {
          ...
          "TIPO')
    || ('_EXTRA_CONTR_SP_FUT":{"type":[ "TM1DataColumnText"] ,"columnGroupShow":"always"}
        }
      } ,
...
"UniqueName"
    ...
    || ('true, "type":[ "TM1DataColumnInteger" ,"numericColumn"] },
        "childrenCustomTypes"  : {
    ...
    || ('rizione_plus_Codice","width":200,"hide":false,"rowGroup": false , "editable": false,"type":["TM1Element"]}
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (38,'/Piano_Annuale/Spazi/Spazi_Condivisi',(' {
  "connection": "promo",
  "configurations": [
    {
   ...
   ')
    ...
    || ('dth":200,"hide":true,"rowGroup": true, "editable": false,"type":["TM1Element"]}  ,
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (39,'/Reporting/Copia_in_pianificazione',(' {
    ...
    || ('"{[REP - Sezione Tematica].[Zona Promo -BDGVend]}",
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (40,'/Reporting/Dettaglio_Campagna',(' {
	"connection": "reporting",
	"configurations": [
		{
    ...
    || ('EP - Sezione Tematica].[Zona Promo -BDGVend]}",
            "REP - Meccanica Semplice": "{[REP - Meccanica Semplice].[Meccanica Semplice -BDGVend]}",
            "REP - AVolantino": "{[REP - AVolantino].[AVolantino -BDGVend]}" ,
            "REP - Articolo": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Articolo] )}, 0)} , ASC)}"   ,
    ...
    || ('anica Semplice] )}, 0)} , ASC)}",
				...
				"COLS": {
					...
					"DIMENSIONS": {
						...
						"REP - Misura')
    || (' Reporting Articolo": "{[REP - Misura Reporting Articolo].[Reporting ACQ]}"
					}
				},
				"FROM": "[Reporting Articolo]",
				"WHERE": {
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (41,'/Reporting/Dettaglio_Zona',( '{
	"connection": "reporting",
	"configurations": [
		{
    ...
    || ('ezione Tematica].[Zona Promo -BDGVend]}",
            "REP - Meccanica Semplice": "{[REP - Meccanica Semplice].[Meccanica Semplice -BDGVend]}",
            "REP - AVolantino": "{[REP - AVolantino].[AVolantino -BDGVend]}" ,
            "REP - Articolo": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Articolo] )}, 0)} , ASC)}"   ,
    ...
    || ('LEVEL( {TM1SUBSETALL( [REP - AVolantino] )}, 0)} , ASC)}" ,
                        "REP - Articolo": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Articolo] )}, 0)} , ASC)}"
					}
				},
				"COLS": {
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (42,'/Reporting/Sintesi_Campagna',(' {
	"connection": "reporting",
	"configurations": [
		{
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (43,'/Reporting/Storico_articolo_per_zona_(ACQ)',(' {
	"connection": "reporting",
	"configurations": [
		{
            ...
            "REP - Zona Promo": "{[REP - Zona Promo].[Zona Promo -BDGVend]}",
            "REP - Sezione Tematic')
    || ('a": "{[REP - Sezione Tematica].[Zona Promo -BDGVend]}",
            "REP - Meccanica Semplice": "{[REP - Meccanica Semplice].[Meccanica Semplice -BDGVend]}",
            "REP - AVolantino": "{[REP - AVolantino].[AVolantino -BDGVend]}" ,
            "REP - Articolo": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Articolo] )}, 0)} , ASC)}"   ,
    ...
    || ('LEVEL( {TM1SUBSETALL( [REP - Promozione] )}, 0)} , ASC)}",
          				"REP - Fornitore": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Fornitore] )}, 0)} , ASC)}" ,
						"REP - Compratore": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Compratore] )}, 0)} , ASC)}",
                        "REP - Sezione Tematica": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Sezione Tematica] )}, 0)} , ASC)}",
                        "REP - Meccanica Semplice": "{T')
    || ('M1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Meccanica Semplice] )}, 0)} , ASC)}",
                        "REP - AVolantino": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - AVolantino] )}, 0)} , ASC)}" ,
                        "REP - Articolo": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Articolo] )}, 0)} , ASC)}"
					}
				},
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (44,'/Reporting/Storico_articolo_per_zona_(MKT)',(' {
	"connection": "reporting",
	"configurations": [
		{
            ...
            "REP - Zona Promo": "{[REP - Zona Promo].[Zona Promo -BDGVend]}",
            "REP - Sezione Temat')
    || ('ica": "{[REP - Sezione Tematica].[Zona Promo -BDGVend]}",
            "REP - Meccanica Semplice": "{[REP - Meccanica Semplice].[Meccanica Semplice -BDGVend]}",
            "REP - AVolantino": "{[REP - AVolantino].[AVolantino -BDGVend]}" ,
            "REP - Articolo": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Articolo] )}, 0)} , ASC)}"   ,
    ...
    || ('BYLEVEL( {TM1SUBSETALL( [REP - Promozione] )}, 0)} , ASC)}",
          				"REP - Fornitore": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Fornitore] )}, 0)} , ASC)}" ,
						"REP - Compratore": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Compratore] )}, 0)} , ASC)}",
                        "REP - Sezione Tematica": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Sezione Tematica] )}, 0)} , ASC)}",
                        "REP - Meccanica Semplice": "')
    || ('{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Meccanica Semplice] )}, 0)} , ASC)}",
                        "REP - AVolantino": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - AVolantino] )}, 0)} , ASC)}" ,
                        "REP - Articolo": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Articolo] )}, 0)} , ASC)}"
					}
				},
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (45,'/Reporting/Timone_Reparto',(' {
	"connection": "reporting",
	"configurations": [
		{
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (46,'/Analisi_Budget-Venduto/Articolo',(' {
	"connection": "reporting",
	"configurations": [
		{
            ...
            "REP - Zona Promo": "{[REP - Zona Promo].[Zona Promo -BDGVend]}",
            "REP - Sezione Tem')
    || ('atica": "{[REP - Sezione Tematica].[Zona Promo -BDGVend]}",
            "REP - Meccanica Semplice": "{[REP - Meccanica Semplice].[Meccanica Semplice -BDGVend]}",
            "REP - AVolantino": "{[REP - AVolantino].[AVolantino -BDGVend]}" ,
            "REP - Articolo": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Articolo] )}, 0)} , ASC)}"   ,
    ...
    || ('( {TM1SUBSETALL( [REP - Fornitore] )}, 0)} , ASC)}" ,
						"REP - Compratore": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Compratore] )}, 0)} , ASC)}",
                        "REP - Zona Promo": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Zona Promo] )}, 0)} , ASC)}",
                        "REP - Sezione Tematica": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Sezione Tematica] )}, 0)} , ASC)}",
                        "REP - Meccanica Semplice": "{TM1SORT(  {TM')
    || ('1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Meccanica Semplice] )}, 0)} , ASC)}",
                        "REP - AVolantino": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - AVolantino] )}, 0)} , ASC)}" ,
                        "REP - Articolo": "{TM1SORT(  {TM1FILTERBYLEVEL( {TM1SUBSETALL( [REP - Articolo] )}, 0)} , ASC)}"
					}
				},
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (47,'/Analisi_Budget-Venduto/Categoria',(' {
	"connection": "reporting",
	"configurations": [
		{
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (48,'/Timone/Foto_Speciali/Riepilogo',(' {
  "connection": "promo",
  "configurations": [{
    ...
    "MDX": {
      "ROWS": {
        ...
        "DIMENSIONS": {
          ...
          "Comprat')
    || ('ore": "{{[Compratore].[S000]},{EXCEPT( {{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, ASC)}} , {[Compratore].[S000]} )}}"
        }
      },
      "COLS": {
        "NON_EMPTY": true,
    ...
    || ('T]},{[Scenario].[TGT_ACQ]},{[Scenario].[TGT_MKT]}}",
    ...
    "DynamicColumnsSettings": {
      "headerco')
    || ('nf": ["MUI_DescrizioneData","Descrizione","Descrizione","Descrizione"],
      "headerdefaults": {
        "marryChildren": true
      },
      "headerCustomTypes":{
    ...
    || ('==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)",
    ...
    || ('ta.Compratore.Name != ''S000'' ))"
    }
  }]
}
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (49,'/Timone/Foto_Speciali/Target',(' {
	"connection": "promo",
	"configurations": [{
		...
		"MDX": {
			"ROWS": {
				...
				"DIMENSIONS": {
					...
					"Categoria": "{')
    || ('{[Categoria].[CAT_0000]},{[Categoria].[MUI_TargetCategoria]}  ,{EXCEPT( {{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Categoria] )}, 0)}, ASC)}} , {[Categoria].[CAT_0000]}) }}"
				}
			},
			"COLS": {
				"NON_EMPTY": true,
				"DIMENSIONS": {
					...
					"Sezione Tematica": "{{TM1SUBSETALL( [Sezione Tematica] )}}",
					"Misura ')
    || ('Timone.": "{[Misura Timone.].[(II) Timone Categoria Sez]}"
				}
			},
			"FROM": "[Timone Categoria Sezione]",
			"WHERE": {
...
')
    ...
    || ('OMP'' && data.Categoria.MUI_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_Level > 0)",
			...
			"row_style_2": "data.Compratore.Name==''S000'' && [''_REP_01_01'',''_REP_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
			"row_style')
    || ('_3": "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 1",
    ...
    || ('me)) || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
		}
	}]
}
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (50,'/Timone/Spazi_Campagna/Target_Categoria',(' {
	"connection": "promo",
	"configurations": [{
		...
		"MDX": {
			"ROWS": {
				...
				"DIMENSIONS": {
					"Compratore": "{{[Compratore].[S000]},{[Compratore].[TOT_COMP]},{EXCEPT( {{{TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}}} , {[Compratore].[S000]} )}  }" ,
					"Categoria": "{{[Categoria')
    || ('].[MUI_TargetCategoria]}  ,{EXCEPT( {{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Categoria] )}, 0)}, ASC)}} , {[Categoria].[CAT_0000]}) }}"
				}
			},
			"COLS": {
				"NON_EMPTY": false,
...
"UniqueName"
    ...
    || ('P":  {
		...
		"columnDefs": [
			...
			{"headerName":"Comprato')
    || ('re","field":"Compratore.Descrizione","width":70,"hide":true,"rowGroup": true, "pinned": "left", "editable": false,"type":["TM1Element"]},
			...
			{"headerName":"Categoria"')
    || (',"field":"Categoria.Descrizione","width":70,"hide":false,"rowGroup": false, "pinned": "left", "editable": false,"type":["TM1Element"]},
			{"headerName":"Cod Categoria","field":"Categoria.Name","width":70,"hide":true,"rowGroup": false,  "editable": false,"type":["TM1Element"]}
		],
		"rowClassRules": {
			"row_style_hidden": "(data.Compratore.Name == ''TOT_COMP'' && data.Categoria.MUI_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_Level > 0)",
			"row_style_1" : "dat')
    || ('a.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)",
			"row_style_2" : "data.Compratore.Name==''S000'' && [''_REP_01_01'',''_REP_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
			"row_style_3" : "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 1",
			"row_style_4" : "data.Compratore.Name==''TOT_COMP'' && dat')
    || ('a.Categoria.MUI_Level == 2"
		},
		"groupRowAggNodes": {
			"nodeGroupTrue" : "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore.Name != ''S000''",
    ...
    || ('egoria.Name  == ''_REP_11'' || data.Categoria.Name  == ''_REP_12'' || data.Categoria.Name  == ''_REP_14'' || data.Categoria.Name  == ''_REP_50'') || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
		}
	}]
}'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (51,'/Timone/Spazi_Campagna/Target_Reparto',(' {
  "connection": "promo",
  "configurations": [
    {
    ...
    || ('mozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
    ...
    || ('[VSC_PIC]},{[Misura Timone.].[VSC_MED]},{[Misura Timone.].[VSC_GRA]},{[Misura Timone.].[CLN]},{[Misura Timone.].[TVL]},{[Misura Timone.].[N_ART_PROMO]}}"
          }
        },
        "FROM": "[Timone Reparto]",
        "WHERE": {
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (52,'/Timone/Target_Categoria/Data',(' {
	"connection": "promo",
	"configurations": [{
    ...
    || ('{TM1SUBSETALL( [Categoria] )}, 0)}, ASC)}} , {[Categoria].[CAT_0000]}) }}"
				}
			},
			"COLS": {
				"NON_EMPTY": false,
    ...
    || ('sura Timone.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NETTO]},{[Misura Timone.].[MARGINE_LORDO__perc_]},{[Misura Timone.].[D_FOTO_slash_TGT_REP]},{[Misura Timone.].[D_FOTO_SCAFF_slash_TGT_REP]}}"
				}
			},
			"FROM": "[Timone Categoria]",
			"WHERE": {
...
')
    ...
    || ('_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
			"row_style_3": "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 1",
			"row_style_4": "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 2"
		},
		"groupRowAggNodes": {
    ...
    || ('2'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)) || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
		}
	}]
}
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (54,'/Timone/Target_Categoria/Promo',(' {
	"connection": "promo",
	"configurations": [{
    ...
    || ('isura Timone.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NETTO]},{[Misura Timone.].[MARGINE_LORDO__perc_]},{[Misura Timone.].[D_FOTO_slash_TGT_REP]},{[Misura Timone.].[D_FOTO_SCAFF_slash_TGT_REP]}}"
				}
			},
			"FROM": "[Timone Categoria]",
			"WHERE": {
...
')
    ...
    || ('P_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
			"row_style_3": "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 1",
			"row_style_4": "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 2"
		},
		"groupRowAggNodes": {
    ...
    || ('02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)) || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
		}
	}]
}
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (55,'/Timone/Target_Reparto/Data',(' {
  "connection": "promo",
  "configurations": [
    {
      ...
      "MDX": {
        "ROWS": {
          ...
          "DIMENSIONS": {
            "Promozione": "{ ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}",
            "Rep')
    || ('arto": "{{ORDER( {TM1FILTERBYLEVEL( {[Reparto].[(II)Reparto]}, 0)},[Reparto].[MUI_Sort],  BASC)}}"
          }
        },
        "COLS": {
          "NON_EMPTY": false,
 ...
 ')
    ...
    || ('li",
            ...
            },
            {
              "headerName": "N. Foto Spec. Banco",
              "field"')
    || (': "Scenario$TGT_ACQ$$MisuraTimone_dot_$N_FOTO_SCAFFALE_SPEC",
              "width": 80,
              "hide": true,
              "rowGroup": false,
              "aggFunc": "sum",
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (56,'/Timone/Target_Reparto/Promo',(' {
  "connection": "promo",
  "configurations": [
    {
...
')
    || ('              "field": "Scenario$RIF_MKT_DT$$MisuraTimone_dot_$N_FOTO",
            ...
            },
            {
              "headerName": "N. Foto Banco",
              "field": "Scenario$R')
    || ('IF_MKT_DT$$MisuraTimone_dot_$N_FOTO_SCAFFALE",
              "width": 80,
              "hide": false,
              "rowGroup": false,
              "aggFunc": "sum",
    ...
    || ('  "field": "Scenario$TGT_MKT$$MisuraTimone_dot_$N_FOTO_SCAFFALE",
            ...
            },
            {
              "headerName": "N. Foto Speciali",
              "field": "Scenario$TGT_')
    || ('MKT$$MisuraTimone_dot_$N_FOTO_SPEC",
              "width": 80,
              "hide": false,
              "rowGroup": false,
              "aggFunc": "sum",
    ...
    || ('"Totale",
            ...
            },
            {
              "headerName": "N. Foto",
              "field": "Sce')
    || ('nario$TGT_REP$$MisuraTimone_dot_$N_FOTO",
              "width": 80,
              "hide": false,
              "rowGroup": false,
              "aggFunc": "sum",
          ...
          "children": [
            {
              "headerName": "N. Art",
              "field": "Scenario$TGT')
    || ('_ACQ$$MisuraTimone_dot_$N_ART_PROMO",
              "width": 150,
              "hide": true,
              "rowGroup": false,
              "aggFunc": "sum",
...
'),'GRID');
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (57,'/Timone/Associazione_Promo',(' {
	"connection": "promo",
	"configurations": [
		{
...
')
    ...
    || ('L( {TM1SUBSETALL( [Promozione Riferimento] )}, 0)}, ASC)}"
					}
				},
				"COLS": {
					"NON_EMPTY": false,
...
')
    ...
    || ('a Configurazione Riferimento].[Escludi_Venduto],[Misura Configurazione Riferimento].[DESCRIZIONE_RIF]}"
					}
				},
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values (0,'config_filter.json',('[
  		{
