UPDATE MENU SET BEAN = 'agGrid' WHERE EXTERNAL_LINK = 1 AND BEAN IS NULL and TEMPLATE = 1;
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('9','/Fatturazione/Associazione_Articoli_Promozione',TO_CLOB('{
  ...
  "configurations" : [ {
    ...
    "ExecuteMDX" : {
      "Members" :')
    || TO_CLOB(' [ "Name", "Attributes/MUI_Descrizione", "Attributes/Canale", "Attributes/Anno", "Attributes/MUI_Semestre", "Attributes/Descrizione", "Attributes/Riferimento", "UniqueName" ],
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('16','/Pianificazione/Proiezioni',TO_CLOB('{
    ...
    "MDX" : {
      "ROWS" : {
        ...
        "DIMENSIONS" : {
          "Promozione" : "{FILTER( { { ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}}, [Promozione].[Proximity] <> ''Y'')} ",
    ')
    || TO_CLOB('      "Compratore" : "{EXCEPT( {{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, ASC)}} , {[Compratore].[S000]}) }",
      ...
      "COLS" : {
        ...
        "DIMENSIONS" : {
          ...
          "Misura Timone." : "{[Misura Timone.].[MUI_Pr')
    || TO_CLOB('oiezione_Timone_Categoria]}"
        }
      },
 ...
 ')
    ...
    "ExecuteMDX" : {
      "Members" : [ "Name", "Attributes/MUI_Descrizione", "Attributes/Descrizione", "Attributes/DescrizioneCODICE", "Attributes/Fornitore", "')
    || TO_CLOB('Attributes/RepartoDesc", "Attributes/CategoriaDesc", "Attributes/GRMDesc", "Attributes/SubGrmDesc", "UniqueName" ],
      "Cells" : [ "Ordinal", "Value", "Updateable", "Consolidated", "HasPicklist" ]
    },
    "DynamicColumns" : true,
    "DynamicColumnsSettings" : {
  ...
  ')
   ...
   ')
    ...
    || TO_CLOB('_Descrizione",
      ...
      "paramName" : "",
      "refresh" : [ "gc_proie')
    || TO_CLOB('zioni_1", "gc_proiezioni_2", "gc_proiezioni_3" ]
    } ],
    "styleRules" : { }
  }, {
    ...
    || TO_CLOB('C)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}}, [Promozione].[Proximity] <> ''Y'')} ",
      ...
      "COLS" : {
        ...
        "DIMENSIONS" : {
          "Sce')
    || TO_CLOB('nario" : "{[Scenario].[(II) TCS I]}",
...
')
    ...
    || TO_CLOB('n" : "Compratore",
      ...
      "process" : "MUI_DUMMY_CUB.Promozione ')
    || TO_CLOB('Pianificazione Pulizia Articoli",
      "timeout" : -1,
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('1022','/Fatturazione/Contribuzione_Promozioni',TO_CLOB('{
  ...
  "configurations" : [ {
    ...
    || TO_CLOB('( { { ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}}, [Promozione].[Proximity] <> ''Y'')}",
          "Compratore" : "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, DESC)}}",
          "Fornitore" : "{{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Fornitore] )}, 0)}, DESC)}}",
          "Rata" : "{ EXCEPT( { EXCEPT( { EXCEPT( {TM1FILTER')
    || TO_CLOB('BYLEVEL( {TM1SUBSETALL( [Rata] )}, 0)}, { [Rata].[RATA_UNICA] }) }, { [Rata].[PROGR_CONTR] }) }, { [Rata].[PROGR_EX_CONTR] }) }"
        }
      },
      "COLS" : {
        "NON_EMPTY" : true,
    ...
    "ExecuteMDX" : {
      "Member')
    || TO_CLOB('s" : [ "Name", "Attributes/MUI_Descrizione", "Attributes/Canale", "Attributes/Anno", "Attributes/MUI_Semestre", "Attributes/Descrizione", "Attributes/Riferimento", "Attributes/MUI_TOT", "Attributes/MUI_TOTS", "UniqueName" ],
      "Cells" : [ "Ordinal", "Value", "Updateable", "Consolidated", "HasPicklist" ]
    },
    "DynamicColumns" : true,
    "DynamicColumnsSettings" : {
  ...
  "configurations" : [ {
    ...
    "MDX" : {
      ...
      "COLS" : {
        "NON_EMPTY" : true,
        "DIMENSIONS" : {
          "Promozione" : "{[Promozione].[(I) Promozione Proxi')
    || TO_CLOB('mity]}"
        }
      },
    ...
    "actions" : [ {
      ...
      "componentLabel" : "Gestione Fornitori-Articoli",
      "process" : "MUI_DUMMY_Esegui Pr')
    || TO_CLOB('ox Cube Programmazione Fornitori Articoli Gestione Main",
      "timeout" : -1,
  ...
  "configurations" : [ {
    ...
    || TO_CLOB('TERBYLEVEL( {TM1SUBSETALL( [Compratore] )}, 0)}, ASC)}, { [Compratore].[NA], [Compratore].[S000] }) }",
      ...
      "COLS" : {
        "NON_EMPTY" : true,
        "DIMENSIONS" : {
          "PROXReportArticolinoninSET" : "{[PROX Report Articoli non in SET].[No Assortimento],[PROX Report Articoli no')
    || TO_CLOB('n in SET].[In Assortimento],[PROX Report Articoli non in SET].[Non In Assortimento]}"
        }
      },
  ...
  "configurations" : [ {
    ...
    || TO_CLOB('otoSpec_Target_CAT]}",
      ...
      "COLS" : {
        ...
        "DIMENSIONS" : {
          "Promozione" : "{FILTER( { { ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}}, [Promozione].[Proximity] <> ''Y'')}",
          "Scenario" : " {{[Scenario].[RI')
    || TO_CLOB('F_MKT_DT]},{[Scenario].[TGT_MKT]}}",
          "Sezione Tematica" : "{{TM1SUBSETALL( [Sezione Tematica] )}}",
    ...
    "ExecuteMDX" : {
      "Members" : [ "Name", "Level", "Attributes/Descrizione", "Attributes/MUI_DescrizioneData", "Attributes/')
    || TO_CLOB('MUI_Descrizione", "Attributes/CategoryManager", "Attributes/Name", "Attributes/MUI_Level", "UniqueName" ],
      "Cells" : [ "Ordinal", "Value", "Updateable", "Consolidated", "HasPicklist" ]
    },
    "autoGroupColumnDef" : {
      "cellRendererParams" : {
  ...
  "configurations" : [ {
    ...
    "MDX" : {
      "ROWS" : {
        "NON_EMPTY" : true,
        "DIMENSIONS" : {
          "Compratore" : "{ [Compratore].[MUI_Timone_')
    || TO_CLOB('FotoSpec_Target_ACQ] }",
    ...
    "ExecuteMDX" : {
      "Members" : [ "Name", "Level", "Attributes/Descriz')
    || TO_CLOB('ione", "Attributes/MUI_DescrizioneData", "Attributes/MUI_Descrizione", "Attributes/CategoryManager", "Attributes/Name", "Attributes/MUI_Level", "UniqueName" ],
      "Cells" : [ "Ordinal", "Value", "Updateable", "Consolidated", "HasPicklist" ]
    },
    "autoGroupColumnDef" : {
      "cellRendererParams" : {
    ...
    "rowClassRules" : {
      "row_style_hidden" : "(data.Compratore.Name == ''TOT_COMP'' && data.Categoria.MU')
    || TO_CLOB('I_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_Level > 0)  || (data.Compratore.Name === ''S000'' && data.Categoria.Name === ''CAT_0000'')  ",
      "row_style_1" : "data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)",
    ...
    "groupRowAggNodes" : {
      "nodeGroupTrue" : "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore.Name != ''S000''",
      "nodeGroupFalse" : "((data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP')
    || TO_CLOB('_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)) || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
    },
    "css" : ".ag-row-group.ag-row-level-0{background: #28aeff !important;}"
  } ]
}'),'GRID');
  ...
  "configurations" : [ {
    ...
    "MDX" : {
      "ROWS" : {
        "NON_EMPTY" : false,
        "DIMENSIONS" : {
          "Promozione" : "{FILTER( { { ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVE')
    || TO_CLOB('L( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}}, [Promozione].[Proximity] <> ''Y'')}",
          "Reparto" : "{{ORDER( {[Reparto].[REP_01] , [Reparto].[REP_01_01], [Reparto].[REP_01_02], [Reparto].[REP_01_03], [Reparto].[REP_01_04], [Reparto].[REP_09], [Reparto].[REP_12], [Reparto].[REP_12_01], [Reparto].[REP_12_02], [Reparto].[REP_12_04]  },[Reparto].[MUI_Sort],  BASC)}}"
        }
      },
')
    || TO_CLOB('      "COLS" : {
        ...
        "DIMENSIONS" : {
          "Scenario" : " {{[Scenario].[RIF_MKT_DT]},{[Scenario].[TGT_MKT]},{[Scenario].[TGT_REP]},{[Scenario].[TGT_ACQ]}}",
          "Misura Timone." : "{{[Misura Timone.].[N_ART_PROMO]},{[Misura Timone.].[TOT_FOTO]},{[Misura Timone.].[N_FOTO]},{[Misura Timone.].[N_FOTO_SCAFFALE]},{[Misura Timone.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NE')
    || TO_CLOB('TTO]},{[Misura Timone.].[SPZ_CAMP]},{FILTER( {TM1SUBSETALL( [Misura Timone.] )}, [Misura Timone.].[Tipo] = ''Spazi'')}  }"
        }
      },
      "FROM" : "[Timone Reparto]",
      "WHERE" : {
   ...
   ')
    ...
    "actions" : [ {
      "componentId" : "tim_scr_inizializza",
      "componentLabel" : "Inizializza Spazio",
      "process" : "MUI_DUMMY_CUB.Timone Reparto ')
    || TO_CLOB('Inizializza Spazi",
      "timeout" : -1,
      "refresh" : [ "gc_SpaziCampagna_TargetReparto" ],
      "params" : [ {
        "dimension" : "Promozione",
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('124','/Timone/Spazi_Campagna/Target_Reparto_(ACQ)',TO_CLOB('{
  ...
  "configurations" : [ {
    ...
    "colSuppressionEnabled" : false,
    "forceSuppression": true ,
    "Misura Timone." : "{{[Misura Timone.].[N_ART_PROMO]},{[Misura Timone.].[TOT_FOTO]},{[Misura Timone.].[N_FOTO]},{[Misura Timone.].[N_FOTO_SCAFFALE]},{[Misura Timo')
    || TO_CLOB('ne.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NETTO]},{[Misura Timone.].[SPZ_CAMP]},{FILTER( {TM1SUBSETALL( [Misura Timone.] )}, [Misura Timone.].[Tipo] = ''Spazi'')}  }",
 ...
 ')
    ...
    || TO_CLOB(' {
      ...
      "headerName" : "Descrizione + Data",
      "fie')
    || TO_CLOB('ld" : "Promozione.MUI_Descrizione",
      "width" : 400,
      "hide" : true,
      "rowGroup" : true,
      "editable" : false,
    ...
    "rowClassRules" : {
      "row_style_1" : "[''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Repa')
    || TO_CLOB('rto.Name)",
      "row_style_2" : "data.Compratore.Name==''S000'' && [''_REP_01_01'',''_REP_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
      "row_style_3" : "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 1",
      "row_style_4" : "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 2"
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('126','/Timone/Spazi_Campagna/Target_Categoria_(CAT)',TO_CLOB('{
  ...
  "configurations" : [ {
    ...
    ')
    || TO_CLOB('      "Categoria" : "{[Categoria].[MUI_Timone_Spazi_Cat_CAT]}"
        }
      },
      "COLS" : {
        "NON_EMPTY" : true,
    ...
    "rowClassRules" : {
      ...
      "row_style_1" : "data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06''')
    || TO_CLOB(',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)",
      "row_style_2" : "data.Compratore.Name==''S000'' && [''_REP_01_01'',''_REP_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
      "row_style_3" : "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 1",
      "row_style_4" : "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 2"
    },
    "groupRowAggNodes" : {
      "nodeGrou')
    || TO_CLOB('pTrue" : "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore.Name != ''S000''",
      "nodeGroupFalse" : "(data.Compratore.Name == ''S000'' && (data.Categoria.Name  == ''_REP_01'' || data.Categoria.Name  == ''_REP_02'' || data.Categoria.Name  == ''_REP_03'' || data.Categoria.Name  == ''_REP_04'' || data.Categoria.Name  == ''_REP_05'' || data.Categoria.Name  == ''_REP_06'' || data.Categoria.Name  == ''_REP_09'' || data.Categoria.Name  == ''_REP_11'' || data.Categoria.Name  == ''_REP_12'' || dat')
    || TO_CLOB('a.Categoria.Name  == ''_REP_14'' || data.Categoria.Name  == ''_REP_50'') || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
    },
    "css" : ".ag-row-group.ag-row-level-0{background: #28aeff !important;}"
  } ]
}'),'GRID');
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('128','/Timone/Spazi_Campagna/Target_Categoria_(ACQ)',TO_CLOB('{
  ...
  "configurations" : [ {
   ...
   ')
    || TO_CLOB('       "Categoria" : "{[Categoria].[MUI_Timone_Spazi_Cat_ACQ]}"
        }
      },
      "COLS" : {
        "NON_EMPTY" : true,
    ...
    "DynamicColumns" : true,
    "DynamicColumnsSettings" : {
      "headerconf" : [ "MUI_DescrizioneData", "Descrizione", "Descri')
    || TO_CLOB('zione" ],
      "headerdefaults" : {
        "marryChildren" : true
      },
 ...
 ')
  ...
  ')
    ...
    "rowClassRules" : {
      "row_style_hidden" : "(data.Compratore.Name == ''TOT_COMP'' && data.Categoria.MUI_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_Level > 0)",
      "row_style_1" : "data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50')
    || TO_CLOB('''].includes(data.Categoria.Name)",
      "row_style_2" : "data.Compratore.Name==''S000'' && [''_REP_01_01'',''_REP_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
      "row_style_3" : "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 1",
      "row_style_4" : "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 2"
    ...
    "groupRowAggNodes" : {
      "nodeGroupTrue" : "leafChild.data.Compratore.Name != ''TOT_')
    || TO_CLOB('COMP'' && leafChild.data.Compratore.Name != ''S000''",
    ...
    || TO_CLOB('Name  == ''_REP_50'') || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
    },
    "css" : ".ag-row-group.ag-row-level-0{background: #28aeff !important;}"
  } ]
}'),'GRID');
  ...
  "configurations" : [ {
    ...
    || TO_CLOB(',
        "DIMENSIONS" : {
          ...
          "Categoria" : "{{[Categoria].[MUI_TargetCategoria]} ,  {ORDER ( {TM1FILTERBYPATTERN( {TM1SUBSETALL( [Categoria] )}, ''_*'')} ,  [Categoria].[MUI_Sort] , BASC )} ,  {EXCEPT( {{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Categoria] )}, 0)}, ASC)}} , {  {TM1FILTERB')
    || TO_CLOB('YPATTERN( {TM1SUBSETALL( [Categoria] )}, ''_*'')} ,  {[Categoria].[CAT_0000]}}) }  }"
        }
      },
      "COLS" : {
        "NON_EMPTY" : true,
...
')
 ...
 ')
    ...
    || TO_CLOB('.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_Level > 0)",
      "row_style_1" : "data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)",
      "row_style_2" : "data.Compratore.Name==''S000'' && [''_REP_01_01'',''_REP_01_02'',''_REP_01_03'',''_REP_01_04'',''_REP_12_01'',''_REP_12_02'',''_REP_12_04''].includes(data.Categoria.Name)",
      "row_style_3" : "data.Compratore.Name==''TOT_CO')
    || TO_CLOB('MP'' && data.Categoria.MUI_Level == 1",
      "row_style_4" : "data.Compratore.Name==''TOT_COMP'' && data.Categoria.MUI_Level == 2"
    },
    "groupRowAggNodes" : {
      "nodeGroupTrue" : "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore.Name != ''S000''",
      "nodeGroupFalse" : "((data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)) || (data.Comp')
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('132','/Timone/Target_Categoria/Promo_(ACQ)',TO_CLOB('{
 ...
 ')
    ...
    || TO_CLOB('].[Proximity] <> ''Y'')}",
          ...
          "Misura Timone." : "{{[Misura Timone.].[N_ART_PROMO]},{[Misura Timone.].[TOT_FOTO]},{[Misura Timone.].[N_FOTO]},{[Misura Timone.].[N_FOTO_SCAFFALE]},{[Misura Timone.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NETTO]},{[Misura Timone.].[MARGINE_LORDO_%]},{[Misura Timone.].[D_FOTO/TG')
    || TO_CLOB('T_REP]},{[Misura Timone.].[D_FOTO_SCAFF/TGT_REP]},{[Misura Timone.].[ASSORT_P]}}"
        }
      },
      "FROM" : "[Timone Categoria]",
      "WHERE" : {
 ...
 ')
   ...
   ')
    ...
    "groupRowAggNodes" : {
      "nodeGroupTrue" : "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore.Name != ''S000''",
      "nodeGroupFalse" : "((data.Compr')
    || TO_CLOB('atore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)) || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
    },
    "css" : ".ag-row-group.ag-row-level-0{background: #28aeff !important;}"
  } ]
}'),'GRID');
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('134','/Timone/Target_Categoria/Data_(CAT)',TO_CLOB('{
  ...
  "configurations" : [ {
    ...
    || TO_CLOB(': true,
        "DIMENSIONS" : {
          "Compratore" : "{{[Compratore].[S000]},  {ORDER ( {EXCEPT ( { TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] ) }   , 0 ) } , {[Compratore].[S000] })} , [Compratore].[MUI_Sort] , BASC )}  }",
          "Categoria" : "{{[Categoria].[MUI_TargetCategoria]} ,  {ORDER ( {TM1FILTERBYPATTERN( {TM1SUBSETALL( [Categoria] )}, ''_*'')} ,  [Categoria].[MUI_Sort] , BASC )} ,  {EXCEPT( {{TM1SORT( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Categoria] )}, 0)}, ASC)}} , {  {TM1F')
    || TO_CLOB('ILTERBYPATTERN( {TM1SUBSETALL( [Categoria] )}, ''_*'')} ,  {[Categoria].[CAT_0000]}}) }  }"
        }
      },
      "COLS" : {
        "NON_EMPTY" : true,
  ...
  ')
    ...
    "columnDefs" : [ {
      ...
      "headerName" : "Compratore",
      "field" : "Compratore.MUI_Descrizio')
    || TO_CLOB('ne",
      "width" : 70,
      "hide" : true,
      "rowGroup" : true,
    ...
    "groupRowAggNodes" : {
      "nodeGroupTrue" : "leafChild.data.Compratore.Name != ''TOT_COMP'' && leafChild.data.Compratore.Name != ''S000''",
      "nodeGroupFalse" : "((data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)) || (da')
    || TO_CLOB('ta.Compratore.Name == ''TOT_COMP'' && data.Categoria.Name.indexOf(''DIR_'') > -1 ) || (data.Compratore.Name != ''TOT_COMP'' && data.Compratore.Name != ''S000'' ))"
    },
    "css" : ".ag-row-group.ag-row-level-0{background: #28aeff !important;}"
  } ]
}'),'GRID');
...
Insert into MUIPROMO.CONFIGURATION (ID_CONFIGURATION,PATH,JSON,TYPE) values ('136','/Timone/Target_Categoria/Data_(ACQ)',TO_CLOB('{
  ...
  "configurations" : [ {
    ...
    || TO_CLOB(' true,
        "DIMENSIONS" : {
          "Compratore" : "{{[Compratore].[S000]},{[Compratore].[TOT_COMP]},  {ORDER ( {EXCEPT ( { TM1FILTERBYLEVEL( {TM1SUBSETALL( [Compratore] ) }   , 0 ) } , {[Compratore].[S000] })} , [Compratore].[MUI_Sort] , BASC )}  }",
          "Categoria" : "{    {[Categoria].[CAT_0000]} , {[Categoria].[MUI_TargetCategoria]} ,  {ORDER ( {TM1FILTERBYPATTERN( {TM1SUBSETALL( [Categoria] )}, ''_*'')} ,  [Categoria].[MUI_Sort] , BASC )} ,  {EXCEPT( {{TM1SORT( {TM1FILTERBYLEVE')
    || TO_CLOB('L( {TM1SUBSETALL( [Categoria] )}, 0)}, ASC)}} , {  {TM1FILTERBYPATTERN( {TM1SUBSETALL( [Categoria] )}, ''_*'')} ,  {[Categoria].[CAT_0000]}}) }  }"
        }
      },
      "COLS" : {
        "NON_EMPTY" : true,
        "DIMENSIONS" : {
          "Promozione" : "{FILTER( { { ORDER( ORDER( {{ORDER( {TM1FILTERBYLEVEL( {TM1SUBSETALL( [Promozione] )}, 0)},[Promozione].[Data_Inizio_Ist.], BDESC)}} , [Promozione].[Canale], BASC),[Promozione].[Tipo Promozione],BASC)}}, [Promozione].[Proximity] <> ''')
    || TO_CLOB('Y'')}",
          "Scenario" : " {{[Scenario].[RIF_MKT_DT]},{[Scenario].[TGT_MKT]},{[Scenario].[TGT_ACQ]}}",
          "Misura Timone." : "{{[Misura Timone.].[N_ART_PROMO]},{[Misura Timone.].[TOT_FOTO]},{[Misura Timone.].[N_FOTO]},{[Misura Timone.].[N_FOTO_SCAFFALE]},{[Misura Timone.].[N_FOTO_SPEC]},{[Misura Timone.].[N_FOTO_SCAFFALE_SPEC]},{[Misura Timone.].[N_FOTO_ULT]},{[Misura Timone.].[VENDUTO_PROMO_NETTO]},{[Misura Timone.].[MARGINE_LORDO_%]},{[Misura Timone.].[D_FOTO/TGT_REP]},{[Misura T')
    || TO_CLOB('imone.].[D_FOTO_SCAFF/TGT_REP]},{[Misura Timone.].[ASSORT_P]} }"
        }
      },
      "FROM" : "[Timone Categoria]",
      "WHERE" : {
    ...
    "ExecuteMDX" : {
      "Members" : [ "Name", "Level", "Attributes/Descrizione", "Attributes/MUI_Descrizione", "Attributes/MUI_DescrizioneData", "Attributes/CategoryManager", "Attributes/Name", "Attributes/MUI_Level", "UniqueName" ],
      "Cells" : [ "Ordinal", "Value", "Updateable", "Consolidated", "H')
    || TO_CLOB('asPicklist" ]
    },
    "autoGroupColumnDef" : {
      "cellRendererParams" : {
...
')
    ...
    || TO_CLOB('
      ...
      "h')
    || TO_CLOB('eaderName" : "Livello Categoria",
      "field" : "Categoria.MUI_Level",
      "width" : 70,
      "hide" : true,
      "rowGroup" : false,
    ...
    "rowClassRules" : {
      "row_style_hid')
    || TO_CLOB('den" : "(data.Compratore.Name == ''S000'' && data.Categoria.Name == ''CAT_0000'') || (data.Compratore.Name == ''TOT_COMP'' && data.Categoria.MUI_Level == 0) || (data.Compratore.Name != ''TOT_COMP'' && data.Categoria.MUI_Level > 0)",
      "row_style_1" : "data.Compratore.Name==''S000'' && [''_REP_01'',''_REP_02'',''_REP_03'',''_REP_04'',''_REP_05'',''_REP_06'',''_REP_09'',''_REP_11'',''_REP_12'',''_REP_14'',''_REP_50''].includes(data.Categoria.Name)",
